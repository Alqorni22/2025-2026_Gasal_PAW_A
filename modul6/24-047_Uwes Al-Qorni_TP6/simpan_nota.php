...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    ...
    $queryMaster = mysqli_query($koneksi, "INSERT INTO nota (no_nota, tgl_nota, nama_pelanggan) VALUES ('$no_nota', '$tgl_nota', '$nama_pelanggan')"); 
    ...
    if ($queryMaster) { 
        ...
        for ($i = 0; $i < count($_POST['nama_barang']); $i++) { 
            ...
            mysqli_query($koneksi, "INSERT INTO nota_detail (id_nota, nama_barang, qty, harga) VALUES ('$id_nota', '$barang', '$qty', '$harga')"); 
        } 
